defmodule VerwatchWeb.RecordControllerTest do
  use VerwatchWeb.ConnCase

  alias Verwatch.Records

  @create_attrs %{datetime: ~N[2010-04-17 14:00:00], info: "some info", name: "some name", version: "some version"}
